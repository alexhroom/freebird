...
instance Options MainOptions where
    defineOptions = pure MainOptions
        ...
        , optionShortFlags = ['w']
        , optionDefault = ""
        , optionDescription = "The directory to weave to. Defaults to working directory."
        })
        <*> defineOption optionType_string (\o -> o
        {
        ...
        , optionShortFlags = ['t']
        , optionDefault = ""
        , optionDescription = "The directory to tangle to. Defaults to working directory."
        })
...
main = do
         ...
         let opts = fromMaybe MainOptions {optWeaveDir = "", optTangleDir = ""} (parsedOptions parsed)
...
processFile weavedir tangledir file = do
        ...
        if not (any isHeader blocks)
                ...
                let tanglefile = tangledir </>
                                 file -<.> unpack (tomlHeaderTangle header)
                let weavefile = weavedir </>
                                file -<.> unpack (tomlHeaderWeave header)
